...
"""
    This file defines the activityThumbnails templatag wich allows to generate
    the html code for showing activities as thumnails, with their associated modals 
"""
			      ...
			      <div class='modal-body'>
			        ...
			        <div class='row row-centered' >
			          <div class='col-md-8 col-centered' >
			            ...
			            <h4 class='blacktext'> Guide : """ + activity.guide.user.username + """</h4>
			            <button class="btn btn-default" onclick="redirect_page('/guide=""" + activity.guide.user.username + """');">See profile</button>
...
@register.filter(name='activityThumbnails')
def activityThumbnails(activity_list):
